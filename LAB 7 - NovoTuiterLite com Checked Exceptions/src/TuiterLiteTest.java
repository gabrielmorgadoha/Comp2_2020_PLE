...
public class TuiterLiteTest {
    ...
    @Test
    public void testeAutorDoTuite() throws TamanhoMaximoException, UsuarioInvalidoException {
    ...
    @Test
    public void testeTuiteDeUsuarioDesconhecido() throws TamanhoMaximoException, UsuarioInvalidoException {
        try {
            tuiterLite.tuitarAlgo(new Usuario("Usuário Desconhedido", "unknown@void.com"), "Testando");
            fail("Não deve ser possível tuitar algo se o usuário é desconhecido");
    ...
    @Test
    public void testeUsuarioInvalidoException() throws TamanhoMaximoException, UsuarioInvalidoException {
        try {
            tuiterLite.tuitarAlgo(new Usuario("Usuário Falso", "emailfake@hotmail@gmail.yahoo"), "Testando");
        } catch (UsuarioInvalidoException e) {
            System.out.println(String.format("Usuario %s não está cadastrado.", e.getUsuarioInvalido()));
        }
    }

    @Test
    public void testeTamanhoTuite() throws TamanhoMaximoException, UsuarioInvalidoException {
        ...
        for (int excessoCaracteres = 1; excessoCaracteres <= 100; excessoCaracteres++) {
            ...
            try {
                ...
                fail("Um tuite maior do que o tamanho máximo deve ser ignorado");
            } catch (TamanhoMaximoException e) {
    ...
    @Test
    public void testeTamanhoMaximoException() throws TamanhoMaximoException, UsuarioInvalidoException {
        ...
        try {
            ...
            System.out.println(String.format("O tuite é %d caractere(s) maior que o máximo de caracteres permitido.", e.getLetrasExcedentes()));
        }
    }

    @Test
    @SuppressWarnings("unchecked")
    public void testeAnexo() throws TamanhoMaximoException, UsuarioInvalidoException {
    ...
    @Test
    public void testeApenasUmTipoPermitidoComoAnexo() throws TamanhoMaximoException, UsuarioInvalidoException {
...
//        tuite.anexarAlgo(new Object());  // essa linha, se fosse descomentada, daria erro de compilação
    ...
    @Test
    public void testeHashtags() throws TamanhoMaximoException, UsuarioInvalidoException {
    ...
    @Test
    public void testeTipoUsuario() throws TamanhoMaximoException, UsuarioInvalidoException {
        // sanity check
    ...
    /////
    @Test
    public void testePerformanceContabilizacaoDasHashtags() throws TamanhoMaximoException, UsuarioInvalidoException {
    ...
    /////
    @Test
    public void testePerformanceTuites() throws TamanhoMaximoException, UsuarioInvalidoException {
